...
<section style="
    background: linear-gradient(135deg, rgba(26,26,46,0.92), rgba(51,51,51,0.92)), url('/images/bg-01.jpg');
...
">
    <div style="max-width: 800px; margin: auto;">
        <div style="width:65px; height:65px; margin:0 auto 18px; border-radius:18px; background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,255,0.2); display:flex; align-items:center; justify-content:center; font-size:28px; backdrop-filter: blur(5px);">
            🛍️
        </div>
...
<section style="background:#f6f7fb; padding:50px 20px; min-height:60vh;">
    <div style="max-width:1200px; margin:auto;">
        <div style="background:white; border-radius:18px; padding:20px; box-shadow:0 10px 30px rgba(0,0,0,0.05);">
            <filter-component
