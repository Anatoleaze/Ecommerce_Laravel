        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            ...
            <div>
                @php
                    ...
                    $startPage = max(1, ($currentBlock - 1) * $blockSize + 1);
                    $endPage = min($lastPage, $currentBlock * $blockSize);
                @endphp

                <ul class="pagination flex-nowrap" style="overflow-x:auto; white-space: nowrap;">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
